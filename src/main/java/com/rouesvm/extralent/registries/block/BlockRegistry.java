...
import com.rouesvm.extralent.block.transport.TeleporterBlock;
...
public class BlockRegistry {
    ...
    public static final MachineBlock TELEPORTER = registry(new TeleporterBlock(AbstractBlock.Settings.create().hardness(2f)));
